    ...
    <main class="max-w-5xl mx-auto px-6 py-12 space-y-12">
      ...
      <section class="border-4 border-ink bg-paper p-8 space-y-6">
        ...
        <form
          ...
          class="space-y-4 border-3 border-charcoal bg-cream p-4"
        >
          <input
            v-model="honeypot"
            type="text"
          ...
          <div class="grid grid-cols-1 gap-3 md:grid-cols-3">
            <input
              ...
              maxlength="80"
              placeholder="Name"
            class="w-full border-2 border-charcoal bg-paper px-3 py-2 text-sm text-ink placeholder:text-smoke transition-transform focus:outline-none focus:-translate-x-1 focus:-translate-y-1 focus:shadow-outline"
            />
            <input
            ...
            <button
              :disabled="loading"
              type="submit"
              class="border-2 border-charcoal px-4 py-2 text-sm uppercase tracking-[2px] transition-transform hover:-translate-y-1 disabled:opacity-60 disabled:pointer-events-none"
            >
          ...
          <textarea
            ...
            maxlength="2000"
            placeholder="Comment..."
            class="w-full border-2 border-charcoal bg-paper px-3 py-2 text-sm text-ink placeholder:text-smoke transition-transform focus:outline-none focus:-translate-x-1 focus:-translate-y-1 focus:shadow-outline min-h-[120px]"
          ></textarea>
        ...
        <div class="space-y-4">
          ...
          <div class="border-3 border-charcoal bg-cream p-4 max-h-72 overflow-y-auto space-y-4">
            <div
              v-for="c in comments"
              :key="c.id"
