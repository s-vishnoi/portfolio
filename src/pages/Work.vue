  ...
  <section class="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8 sm:space-y-12">
    ...
    >
      ...
      <div>
        ...
        <div class="bg-[#e7dcc8] p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between transition-transform duration-200 hover:-translate-x-1 hover:-translate-y-1 hover:shadow-outline">
          <div>
    ...
    <div
      v-else
      class="border border-smoke/40 bg-[#e7dcc8] p-4 sm:p-6 space-y-6 sm:space-y-8"
    >
      <h2 class="text-lg sm:text-xl font-semibold uppercase tracking-[1px] sm:tracking-[2px] flex flex-wrap items-center gap-3">
        <img src="/logos/NU_PA_logo.svg" alt="NU logo" class="h-8 border border-smoke/30 bg-cream p-0" />
      ...
      <div class="bg-[#e7dcc8] p-4 sm:p-6 space-y-4">
