  ...
  <section class="max-w-4xl mx-auto px-6 py-12 space-y-12">
    <div class="border-4 border-ink bg-paper p-6">
      ...
      <div class="flex flex-wrap gap-4">
        <button
          ...
          :class="[
            'w-60 px-4 py-3 border-2 border-ink uppercase tracking-[2px] transition-transform duration-200',
    ...
    >
      <h2 class="text-lg font-semibold uppercase tracking-[2px] flex flex-wrap items-center gap-3">
        <img src="/logos/NU_PA_logo.svg" alt="NU logo" class="h-8 border-2 border-ink bg-cream p-1" />
      ...
      <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <a
          ...
          target="_blank"
          class="inline-flex items-center gap-2 border-2 border-ink px-4 py-2 uppercase tracking-[1px] hover:-translate-y-0.5 transition-transform"
        >
          Request a Consult ↗
        </a>
      </div>
        ...
        >
          <div class="flip-card">
            <div class="flip-card-inner">
              <div class="flip-card-front border-3 border-ink bg-paper flex items-center justify-center text-center">
                <h3 class="text-sm font-semibold uppercase tracking-[1px] text-ink">
                  {{ consult.topic }}
                </h3>
              </div>
              <div class="flip-card-back border-3 border-ink bg-cream text-xs text-charcoal flex items-center justify-center text-center p-4 leading-relaxed">
                {{ consult.description }}
              </div>
            </div>
          </div>
      ...
      <div>
        ...
        <div class="border-3 border-ink bg-paper p-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
          ...
          <a
            ...
            target="_blank"
            class="inline-flex items-center gap-2 border-2 border-ink px-4 py-2 uppercase tracking-[1px] hover:-translate-y-0.5 transition-transform whitespace-nowrap"
          >
            Open-source code ↗
          </a>
        </div>
    ...
    >
      ...
      <div class="border-3 border-ink bg-paper p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 md:grid-cols-3 border-3 border-ink bg-cream p-4">
          <span
...
.testimonial-tile {
  @apply italic text-sm text-charcoal px-3 py-2 border border-ink bg-paper transition-transform duration-300;
}
