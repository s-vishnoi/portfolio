<template>
  <main class="max-w-4xl mx-auto px-6 py-12 space-y-16">
    ...
    <section id="about" class="border-4 border-ink bg-paper p-8">
      <div class="flex flex-col md:flex-row gap-8 items-start">
        <img
          ...
          class="w-32 h-32 md:w-40 md:h-40 object-cover rounded-full border-3 border-charcoal"
        />
        <div>
          ...
          <div class="mt-6 flex flex-wrap gap-4 text-sm font-semibold uppercase tracking-[2px]">
            <a
              ...
              target="_blank"
              class="inline-flex items-center gap-2 border-2 border-charcoal px-4 py-2 hover:-translate-y-0.5 transition-transform"
            >
              Email ↗
            </a>
            <a
    ...
    <section id="projects" class="border-4 border-ink bg-paper p-8">
      ...
      <div class="grid gap-6 md:grid-cols-2">
        <component
          ...
          class="block border-3 border-charcoal bg-paper p-6 transition-transform duration-200 hover:-translate-x-1 hover:-translate-y-1 hover:shadow-outline focus:-translate-x-1 focus:-translate-y-1 focus:shadow-outline outline-none"
        >
          <img
            :src="project.image"
            :alt="project.title"
            class="w-full h-48 object-cover border-3 border-charcoal mb-4"
          />
    ...
    <section id="roles" class="border-4 border-ink bg-paper p-8">
      ...
      <div class="grid gap-4">
        <a
          ...
          :href="role.link"
          target="_blank"
          class="border-3 border-charcoal bg-paper p-6 flex flex-col md:flex-row gap-4 items-start transition-transform duration-200 hover:-translate-x-1 hover:-translate-y-1 hover:shadow-outline"
        >
          <img :src="role.logo" class="h-12 border-2 border-charcoal bg-cream p-2" />
          <div>
    ...
    <section id="skills" class="border-4 border-ink bg-paper p-8">
      ...
      <div class="grid gap-4 md:grid-cols-2">
        <div
          ...
          :key="index"
          class="border-3 border-charcoal bg-paper p-6 transition-transform duration-200 hover:-translate-x-1 hover:-translate-y-1 hover:shadow-outline group"
            ...
            >
              ...
              <div class="flex flex-wrap gap-2 text-xs">
                <span
                  ...
                  :key="tag"
                  class="inline-block border border-charcoal bg-cream px-2 py-1 uppercase tracking-[1px]"
                >
                  {{ tag }}
                </span>
              </div>
    ...
    <section id="achievements" class="border-4 border-ink bg-paper p-8">
      ...
      <div class="grid gap-4 md:grid-cols-2">
        <div class="border-3 border-charcoal bg-paper p-4 flex items-start gap-3">
